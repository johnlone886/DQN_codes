...
class DQN(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(state_channel, 32, kernel_size=8, stride=4)  # (84 + 2*0-8)/4+1=20
...
class DQNAgent:
    ...
    def observe(self, lazyframe):#将lazyframe格式转为tensor
    ...
    def compute_td_loss(self, states, actions, rewards, next_states, is_done):
        ...
        predicted_next_qvalues = self.DQN(next_states)
